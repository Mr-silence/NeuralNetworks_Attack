...
# 从文件加载图像
#输入的文件路径
image_path = 'C:\\Users\\1\\Desktop\\attackimage\\ILSVRC2012_val_00000006.JPEG'
...
labels = torch.randint(0, num_classes, (1,)).to(image.device)

# 发起攻击
adv_images = atk(image, labels)

# 定义保存攻击后图像的目录
output_dir = 'C:\\Users\\1\\Desktop\\save'
